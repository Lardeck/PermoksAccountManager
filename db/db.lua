...
PermoksAccountManager.raids = {
	[2912] = {
		name = GetRealZoneText(2912),
		englishID = "the_voidspire",
		instanceID = 1307,
		startIndex = 1,
		endIndex = 6,
		startAtZero = true,
	...
	[2913] = {
		name = GetRealZoneText(2913),
		englishID = "march_on_queldanas",
		instanceID = 1308,
		startIndex = 1,
		endIndex = 2,
		startAtZero = true,
	...
	[2939] = {
		name = GetRealZoneText(2939),
		englishID = "the_dreamrift",
		instanceID = 1314,
		startIndex = 1,
		endIndex = 1,
	},
...
PermoksAccountManager.factions = {
	...
	-- 11.1
	[2653] = { name = "The Cartels of Undermine", paragon = true, type = "renown", warband = "unique" },
	[2669] = { name = "Darkfuse Solutions", paragon = true, type = "renown", warband = "unique" },
	[2671] = { name = "Venture Company", paragon = true, warband = "unique" },
	[2673] = { name = "Bilgewater Cartel", paragon = true, warband = "unique" },
...
PermoksAccountManager.currency = {
	...
	[3107] = 0, -- Weathered Undermine Crest
	[3108] = 0, -- Carved Undermine Crest
	[3109] = 0, -- Runed Undermine Crest
	[3110] = 0, -- Gilded Undermine Crest
	[3116] = 0, -- Essence of Kaja'mite (Catalyst Charges TWW Season 2)

	[3132] = 0, -- Spark Drops
	[3218] = 0, -- Empty Kaja'Cola Can
	[3220] = 0, -- Vintage Kaja'Cola Can
...
PermoksAccountManager.quests = {
	...
	preys_nightmare = {
		...
		[91213] = { questType = "weekly", log = true },
		[91215] = { questType = "weekly", log = true },
		[91217] = { questType = "weekly", log = true },
		[91219] = { questType = "weekly", log = true },
		[91221] = { questType = "weekly", log = true },
		[91223] = { questType = "weekly", log = true },
		[91225] = { questType = "weekly", log = true },
		[91227] = { questType = "weekly", log = true },
		[91229] = { questType = "weekly", log = true },
		[91231] = { questType = "weekly", log = true },
		[91233] = { questType = "weekly", log = true },
		[91235] = { questType = "weekly", log = true },
		[91237] = { questType = "weekly", log = true },
		[91239] = { questType = "weekly", log = true },
		[91241] = { questType = "weekly", log = true },
		[91256] = { questType = "weekly", log = true },
		[91258] = { questType = "weekly", log = true },
		[91257] = { questType = "weekly", log = true },
		[91259] = { questType = "weekly", log = true },
		[91260] = { questType = "weekly", log = true },
		[91261] = { questType = "weekly", log = true },
		[91262] = { questType = "weekly", log = true },
		[91263] = { questType = "weekly", log = true },
		[91265] = { questType = "weekly", log = true },
		[91264] = { questType = "weekly", log = true },
		[91266] = { questType = "weekly", log = true },

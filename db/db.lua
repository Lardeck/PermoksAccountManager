...
PermoksAccountManager.quests = {
    ...
    isle_of_dorne_rares = {
        [85158] = {questType = 'weekly', warband = true, rare = true, name = 'Alunira'}, -- (daily?!: 82196)
        [84037] = {questType = 'weekly', warband = true, rare = true, name = 'Tephratennae'}, -- (daily: 81923)
        --[81894] = {questType = 'weekly', warband = true, rare = true, name = 'Warphorn'}, -- One Time Kill
        [84031] = {questType = 'weekly', warband = true, rare = true, name = 'Kronolith, Might of the Mountain'}, -- (daily: 81902)
        [84032] = {questType = 'weekly', warband = true, rare = true, name = 'Shallowshell the Clacker'}, -- (daily: 81903)
        --[81893] = {questType = 'weekly', warband = true, rare = true, name = 'Bloodmaw'}, -- One Time Kill
        --[81892] = {questType = 'weekly', warband = true, rare = true, name = 'Springbubble'}, -- One Time Kill
        --[79685] = {questType = 'weekly', warband = true, rare = true, name = 'Sandres the Relicbearer'}, -- One Time Kill
        [84036] = {questType = 'weekly', warband = true, rare = true, name = 'Clawbreaker K\'zithix'}, -- (daily: 81920)
        --[81895] = {questType = 'weekly', warband = true, rare = true, name = 'Emperor Pitfang'},-- One Time Kill
        [84029] = {questType = 'weekly', warband = true, rare = true, name = 'Escaped Cutthroat'}, -- (daily: 81907)
        [84039] = {questType = 'weekly', warband = true, rare = true, name = 'Matriarch Charfuria'}, -- (daily: 81921)
        [84030] = {questType = 'weekly', warband = true, rare = true, name = 'Tempest Lord Incarnus'}, -- (daily: 81901)
        [84028] = {questType = 'weekly', warband = true, rare = true, name = 'Gar\'loc'}, -- (daily: 81899)
        [84033] = {questType = 'weekly', warband = true, rare = true, name = 'Twice-Stinger the Wretched'}, -- (daily: 81904)
        --[78619] = {questType = 'weekly', warband = true, rare = true, name = 'Rustul Titancap'}, -- One Time Kill
        [84034] = {questType = 'weekly', warband = true, rare = true, name = 'Flamekeeper Graz'}, -- (daily: 81905)
        [84026] = {questType = 'weekly', warband = true, rare = true, name = 'Plaguehart'}, --  (daily: 81897)
        [84038] = {questType = 'weekly', warband = true, rare = true, name = 'Sweetspark the Oozeful'}, -- (daily: 81922)
        [85160] = {questType = 'weekly', warband = true, rare = true, name = 'Kereke'}, -- (daily: 82204)
        [85161] = {questType = 'weekly', warband = true, rare = true, name = 'Zovex'}, -- (daily: 82203)
        [85159] = {questType = 'weekly', warband = true, rare = true, name = 'Rotfist'}, -- (daily: 82205)
    },
    ringing_deeps_rares = {
        [84046] = {questType = 'weekly', warband = true, rare = true, name = 'Automaxor'}, -- (daily: 81674)
        [84044] = {questType = 'weekly', warband = true, rare = true, name = 'Charmonger'}, -- (daily: 81562)
        --[80547] = {questType = 'weekly', warband = true, rare = true, name = 'King Splash'}, -- One Time Kill 
        --[80505] = {questType = 'weekly', warband = true, rare = true, name = 'Candleflyer Captain'}, -- One time kill
        [84042] = {questType = 'weekly', warband = true, rare = true, name = 'Cragmund'}, -- (daily: 80560)
        [85162] = {questType = 'weekly', warband = true, rare = true, name = 'Deepflayer Broodmother'}, -- (daily: 80536)
        --[80557] = {questType = 'weekly', warband = true, rare = true, name = 'Aquellion'}, -- One time kill
        [84041] = {questType = 'weekly', warband = true, rare = true, name = 'Zilthara'}, -- (daily: 80506)
        [84045] = {questType = 'weekly', warband = true, rare = true, name = 'Coalesced Monstrosity'}, -- (daily: 81511)
        [84040] = {questType = 'weekly', warband = true, rare = true, name = 'Terror of the Forge'}, -- (daily: 80507)
        [84047] = {questType = 'weekly', warband = true, rare = true, name = 'Kelpmire'}, -- (daily: 81485)
        --[81563] = {questType = 'weekly', warband = true, rare = true, name = 'Rampaging Blight'}, -- One time kill
        [84043] = {questType = 'weekly', warband = true, rare = true, name = 'Trungal'}, -- (daily: 80574)
        [84049] = {questType = 'weekly', warband = true, rare = true, name = 'Spore-infused Shalewing'}, -- (daily: 81652)
        [84048] = {questType = 'weekly', warband = true, rare = true, name = 'Hungerer of the Deeps'}, -- (daily: 81648)
        [84050] = {questType = 'weekly', warband = true, rare = true, name = 'Disturbed Earthgorger'}, -- (daily: 80003)
        --[81566] = {questType = 'weekly', warband = true, rare = true, name = 'Deathbound Husk'}, -- One time kill
        [85163] = {questType = 'weekly', warband = true, rare = true, name = 'Lurker of the Deeps'}, -- (daily: 81633)
    },
    hallowfall_rares = {
        [85164] = {questType = 'weekly', warband = true, rare = true, name = 'Beledar\'s Spawn'}, -- (daily: 81763)
        [85165] = {questType = 'weekly', warband = true, rare = true, name = 'Deathtide'}, -- (daily: 81880)
        [84063] = {questType = 'weekly', warband = true, rare = true, name = 'Lytfang the Lost'}, -- (daily: 81756)
        [84051] = {questType = 'weekly', warband = true, rare = true, name = 'Moth\'ethk'}, -- (daily: 82557)
        [84064] = {questType = 'weekly', warband = true, rare = true, name = 'The Perchfather'}, -- (daily: 81791)
        [84061] = {questType = 'weekly', warband = true, rare = true, name = 'The Taskmaker'}, -- (daily: 80009)
        --[81761] = {questType = 'weekly', warband = true, rare = true, name = 'Grimslice'}, -- One Time Kill
        [84066] = {questType = 'weekly', warband = true, rare = true, name = 'Strength of Beledar'}, -- (daily: 81849)
        --[80006] = {questType = 'weekly', warband = true, rare = true, name = 'Ixlorb the Spinner'}, -- One Time Kill
        [84060] = {questType = 'weekly', warband = true, rare = true, name = 'Murkspike'}, -- (daily: 82565)
        [84053] = {questType = 'weekly', warband = true, rare = true, name = 'Deathpetal'}, -- (daily: 82559)
        --[80011] = {questType = 'weekly', warband = true, rare = true, name = 'Deepfiend Azellix'}, -- One Time Kill
        [84056] = {questType = 'weekly', warband = true, rare = true, name = 'Duskshadow'}, -- (daily: 82562)
        --[81881] = {questType = 'weekly', warband = true, rare = true, name = 'Funglour'}, -- One Time Kill
        [84067] = {questType = 'weekly', warband = true, rare = true, name = 'Sir Alastair Purefire'}, -- (daily: 81853)
        [84065] = {questType = 'weekly', warband = true, rare = true, name = 'Horror of the Shallows'}, -- (daily: 81836)
        [84062] = {questType = 'weekly', warband = true, rare = true, name = 'Sloshmuck'}, -- (daily: 79271)
        --[80010] = {questType = 'weekly', warband = true, rare = true, name = 'Murkshade'}, -- One Time Kill
        [84054] = {questType = 'weekly', warband = true, rare = true, name = 'Croakit'}, -- (daily: 82560)
        [84068] = {questType = 'weekly', warband = true, rare = true, name = 'Pride of Beledar'}, -- (daily: 81882)
        [84052] = {questType = 'weekly', warband = true, rare = true, name = 'Crazed Cabbage Smacker'}, -- (daily: 82558)
        [84055] = {questType = 'weekly', warband = true, rare = true, name = 'Toadstomper'}, -- (daily: 82561)
        [84059] = {questType = 'weekly', warband = true, rare = true, name = 'Finclaw Bloodtide'}, -- (daily: 82564)
        [84058] = {questType = 'weekly', warband = true, rare = true, name = 'Ravageant'}, -- (daily: 82566)
        [84057] = {questType = 'weekly', warband = true, rare = true, name = 'Parasidious'}, -- (daily: 82563)
        [80486] = {questType = 'weekly', warband = true, rare = true, name = 'Brineslash'}, -- BUGGED
    },
    azj_kahet_rares = {
        [84071] = {questType = 'weekly', warband = true, rare = true, name = 'Kaheti Silk Hauler'}, -- (daily: 81702)
        [84072] = {questType = 'weekly', warband = true, rare = true, name = 'XT-Minecrusher 8700'}, -- (daily: 81703)
        --[81695] = {questType = 'weekly', warband = true, rare = true, name = 'Abyssal Devourer'}, -- One Time Kill
        [84075] = {questType = 'weekly', warband = true, rare = true, name = 'Maddened Siegebomber'}, -- (daily: 81706)
        --[81700] = {questType = 'weekly', warband = true, rare = true, name = 'Vilewing'}, -- One Time Kill
        --[81699] = {questType = 'weekly', warband = true, rare = true, name = 'Webspeaker Grik\'ik'}, -- One Time Kill
        [84073] = {questType = 'weekly', warband = true, rare = true, name = 'Cha\'tak'}, -- (daily: 81704)
        [84076] = {questType = 'weekly', warband = true, rare = true, name = 'Enduring Gutterface'}, -- (daily: 81707)
        [84074] = {questType = 'weekly', warband = true, rare = true, name = 'Monstrous Lasharoth'}, -- (daily: 81705)
        --[81694] = {questType = 'weekly', warband = true, rare = true, name = 'Rhak\'ik & Khak\'ik'}, -- One Time Kill
        --[78905] = {questType = 'weekly', warband = true, rare = true, name = 'Ahg\'zagall'}, -- One Time Kill
        [84080] = {questType = 'weekly', warband = true, rare = true, name = 'Umbraclaw Matra'}, -- (daily: 82037)
        [84082] = {questType = 'weekly', warband = true, rare = true, name = 'Skirmisher Sa\'zryk'}, -- (daily: 82078)
        [84081] = {questType = 'weekly', warband = true, rare = true, name = 'Deepcrawler Tx\'kesh'}, -- (daily: 82077)
        [84079] = {questType = 'weekly', warband = true, rare = true, name = 'Harvester Qixt'}, -- (daily: 82036)
        [84078] = {questType = 'weekly', warband = true, rare = true, name = 'The Oozekhan'}, -- (daily: 82035)
        [84077] = {questType = 'weekly', warband = true, rare = true, name = 'Jix\'ak the Crazed'}, -- (daily: 82034)
        [84069] = {questType = 'weekly', warband = true, rare = true, name = 'The Groundskeeper'}, -- (daily: 81634)
        [84070] = {questType = 'weekly', warband = true, rare = true, name = 'Xishorr'}, -- (daily: 81701)
        [85167] = {questType = 'weekly', warband = true, rare = true, name = 'The One Left'}, -- (daily: 82290)
        [85166] = {questType = 'weekly', warband = true, rare = true, name = 'Tka\'ktath'}, -- (daily: 82289)
    },

...
local labelRows = {
    ...
    serpentshrineAttunement = {
        label = 'Serpentshrine',
        data = function(alt_data)
            return (alt_data.questInfo and PermoksAccountManager:CreateQuestString(alt_data.questInfo.attunements.serpentshrine, 1, true)) or '-'
        end,
        group = 'attunement',
        version = WOW_PROJECT_BURNING_CRUSADE_CLASSIC
    },
    ...
    hyjalSummitAttunement = {
        label = 'Hyjal Summit',
        data = function(alt_data)
            return (alt_data.questInfo and PermoksAccountManager:CreateQuestString(alt_data.questInfo.attunements.hyjal, 1, true)) or '-'
        end,
        group = 'attunement',
        version = WOW_PROJECT_BURNING_CRUSADE_CLASSIC
    },
    blackTempleAttunement = {
        label = 'Black Temple',
        data = function(alt_data)
            return (alt_data.questInfo and PermoksAccountManager:CreateQuestString(alt_data.questInfo.attunements.blacktemple, 1, true)) or '-'
        end,
        group = 'attunement',
        version = WOW_PROJECT_BURNING_CRUSADE_CLASSIC
    },
    hillsbradAttunement = {
        label = 'Hillsbrad',
        data = function(alt_data)
            return (alt_data.questInfo and PermoksAccountManager:CreateQuestString(alt_data.questInfo.attunements.hillsbrad, 1, true)) or '-'
        end,
        group = 'attunement',
        version = WOW_PROJECT_BURNING_CRUSADE_CLASSIC
    },
    blackmorassAttunement = {
        label = 'Black Morass',
        data = function(alt_data)
            return (alt_data.questInfo and PermoksAccountManager:CreateQuestString(alt_data.questInfo.attunements.blackmorass, 1, true)) or '-'
        end,
        group = 'attunement',
        version = WOW_PROJECT_BURNING_CRUSADE_CLASSIC
    },
